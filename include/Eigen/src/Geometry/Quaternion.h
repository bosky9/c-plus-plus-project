...
namespace Eigen {
    ...
    public:
        ...
        /** \returns true if at least one pair of coefficients of \c *this and \a other are not exactly equal to each
         * other. \warning When using floating point scalar values you probably should rather use a fuzzy comparison
        ...
        template<typename NewScalarType>
        EIGEN_DEVICE_FUNC inline typename internal::enable_if<!internal::is_same<Scalar, NewScalarType>::value,
...
#include EIGEN_QUATERNIONBASE_PLUGIN
     ...
     * \tparam _Options controls the memory alignment of the coefficients. Can be \# AutoAlign or \# DontAlign. Default
     * is AutoAlign.
     *
...
#include EIGEN_QUATERNION_PLUGIN
    ...
    namespace internal {
        ...
        struct traits<Map<const Quaternion<_Scalar>, _Options>>
            ...
            typedef traits<Quaternion<_Scalar, (int(_Options) & Aligned) == Aligned ? AutoAlign : DontAlign>>
                    TraitsBase;
    ...
    QuaternionBase<Derived>::conjugate() const {
        return internal::quat_conj<Architecture::Target, Derived, typename internal::traits<Derived>::Scalar>::run(
                *this);
    }
